...
const FoodDashboard = () => {
  ...
  const topSellingFoods = [
    ...
    },
    {
      ...
      name: "Steak Kebabs",
      sold: 0,
      image: "https://stackfood-admin.6amtech.com/storage/app/public/product/2021-08-21-6120e44ea58c5.png",
    },
    {
      id: 6,
      name: "FRIED RICE",
      sold: 0,
      image: "https://stackfood-admin.6amtech.com/storage/app/public/product/2021-08-21-6120e4dcd5194.png",
    },
  ]
  ...
  const topRatedFoods = [
    ...
    },
    {
      ...
      rating: 0,
      reviews: 0,
      image: "https://stackfood-admin.6amtech.com/storage/app/public/product/2021-08-21-6120e5955e1d1.png",
    },
    {
      id: 5,
      name: "Cheese Pizza",
    ...
    <div className="food-dashboard">
      <div className="dashboard-container">
        ...
        <div className="dashboard-section">
          <div className="section-header">
            <div className="section-title">
              <img src="https://stackfood-admin.6amtech.com/public/assets/admin/img/dashboard/top-selling.png"className="section-icon selling-icon" />
        ...
        <div className="dashboard-section">
          <div className="section-header">
            <div className="section-title">
              <img src="https://stackfood-admin.6amtech.com/public/assets/admin/img/dashboard/most-rated.png" className="section-icon rated-icon" />
              ...
              <div key={food.id} className="rated-food-card">
                <div className="rated-food-content">
                  <div className="rated-food-image-container">
                    <img src={food.image || "/placeholder.svg"} alt={food.name} className="rated-food-image" />
                  </div>
