...
//   const paymentOptions = ["Paypal", "Stripe", "Razor pay", "Ssl commerz"];
...
//               <X />
//             </button>
//             <div className="BusinessPlan-shift-modal-content">
//               <h2>Shift to New Subscription Plan</h2>
//               <div className="BusinessPlan-shift-details">
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">Commission</span>
//                   <span className="BusinessPlan-shift-value">10%</span>
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">
//                     {selectedPlan.name}
//                   </span>
//                   <span className="BusinessPlan-shift-value">
//                     {selectedPlan.price}
//                   </span>
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label"></span>
//                   <span className="BusinessPlan-shift-value">
//                     {selectedPlan.duration}
//                   </span>
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">Validity</span>
//                   <span className="BusinessPlan-shift-value">
//                     {selectedPlan.duration}
//                   </span>
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">Price</span>
//                   <span className="BusinessPlan-shift-value">
//                     {selectedPlan.price}
//                   </span>
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">Bill status</span>
//                   <span className="BusinessPlan-shift-value">
//                     Migrate to new plan
//                   </span>
//                 </div>
...
//                 </div>
//                 <div className="BusinessPlan-shift-detail-item">
//                   <span className="BusinessPlan-shift-label">Wallet</span>
//                   <span className="BusinessPlan-shift-value">$1,634.00</span>
//                 </div>
//               </div>
//               <div className="BusinessPlan-payment-options">
//                 {paymentOptions.map((option, index) => (
//                   <div key={index} className="BusinessPlan-payment-option">
//                     {option}
//                   </div>
//                 ))}
//               </div>
